...
#    { name = "roboshop.prod.catalogue.docdb_endpoint", value = "docdb-prod.cluster-cfo8mcqcknol.us-east-1.docdb.amazonaws.com", type = "String" },
    ...
    { name = "roboshop.prod.catalogue.mongo_url",
      value = "mongodb://roboshop:roboshop123@docdb-prod-0.cluster-cfo8mcqcknol.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false",
      type = "SecureString" },
    { name = "roboshop.prod.catalogue.docdb_endpoint", value = "docdb-prod-0.cfo8mcqcknol.us-east-1.docdb.amazonaws.com", type = "String" },
